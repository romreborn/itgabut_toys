...
export const T = {
  id: {
    ...
    coAutofillNote: "Data diisi otomatis dari checkout terakhir di perangkat ini.",
    coAutofillClear: "Hapus data tersimpan",
  ...
  en: {
    ...
    coAutofillNote: "Filled in automatically from your last checkout on this device.",
    coAutofillClear: "Clear saved info",
